...
fun UpdateProductScreen(navController: NavController, productId: String, productViewModel: ProductViewModel) {
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        ...
        TextField(
            ...
            label = { Text(updatedProductName.takeUnless { it.isBlank() } ?: "Fact Name") },
        ...
        TextField(
            ...
            label = { Text(updatedProductDescription.takeUnless { it.isBlank() } ?: "Fact Source") },
            modifier = Modifier.fillMaxWidth()
        )
        Spacer(modifier = Modifier.height(8.dp))
        TextField(
            ...
            label = { Text(updatedProductPrice.takeUnless { it.isBlank() } ?: "Fact Number") },
            modifier = Modifier.fillMaxWidth()
        )
        Spacer(modifier = Modifier.height(8.dp))
        Button(onClick = {
