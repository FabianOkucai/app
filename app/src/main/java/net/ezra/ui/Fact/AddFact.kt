    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(text = stringResource(id = R.string.project_id))
                },
                navigationIcon = {
                    IconButton(onClick = {
                        ...
                        navController.navigate(ROUTE_HOME) {
                            popUpTo(ROUTE_INSERT_PRODUCT) { inclusive = true }
                        }
                        ...
                        Column(
                            ...
                            OutlinedButton(onClick = {
                                ...
                                if (photoUri != null) {
                                    ...
                                    Toast.makeText(context, "Please enter Fact", Toast.LENGTH_SHORT).show()
                                }
